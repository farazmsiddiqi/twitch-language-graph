...
<details>
  ...
  <ol>
    ...
    <li>
      <a href="#getting-started">How to run our code</a>
      <ul>
        <li><a href="#prerequisites">Commands to run the assignments</a></li>
        <li><a href="#installation">Selecting input/output locations</a></li>
      </ul>
    </li>
