...
* #### Major code location
  ...
  Under the [.objs](#heading-1 "Goto heading-1") folder, we have three main folders, along with a main.d and main.o file that contain the source paths to the graph and node header files.
